export default {
    ...
    setDAVHeaders: function(res){
        res.setHeader("DAV", "1, 3, extended-mkcol, calendar-access, calendar-schedule, calendar-proxy, calendarserver-sharing, calendarserver-subscribed, access-control, calendarserver-principal-property-search");
